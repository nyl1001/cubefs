...
GOPATH=/go
export DiskPath="$RootPath/dockernew/docker_data"
...
compose="docker-compose --env-file ${RootPath}/dockernew/run_docker.env -f ${RootPath}/dockernew/docker-compose.yml"
