...
create_cold_volume() {
    ...
    curl -v "http://172.16.0.178:17010/admin/createVol?name=${VolName}&volType=1&cacheCap=8&cacheAction=2&capacity=10&owner=${Owner}&mpCount=3"
    curl -v "http://172.16.0.178:17010/client/vol?name=${VolName}&authKey=${md5}" | python -m json.tool
}
